 ...
 * @since 2016年12月30日
 */
public class ExpressionValueParser implements Parser<ExpressionValue> {

	public final static Parser<ExpressionValue> instance = new ExpressionValueParser();
	...
	public boolean support(String name) {
		return name.equals("expression-value");
	}
}
