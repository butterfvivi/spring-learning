...
import org.vivi.framework.ureport.simple.ureport.definition.value.ZxingCategory;
 ...
 * @since 2017年3月6日
 */
public class ZxingValueParser implements Parser<ZxingValue> {
	
	public final static Parser<ZxingValue> instance = new ZxingValueParser();

	@Override
	public ZxingValue parse(Element element) {
	...
	public boolean support(String name) {
		return name.equals("zxing-value");
	}
}
