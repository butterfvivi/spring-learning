 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.simple.ureport.build.aggregate;
...
public class SelectAggregate extends Aggregate {
	...
	protected List<BindData> doAggregate(DatasetExpression expr, Cell cell, Context context, List<?> objList) {
		...
		for (Object o : objList) {
			...
			List<Object> bindList = new ArrayList<Object>(1);
			bindList.add(o);
			Object data = ToolUtils.getProperty(o, property);
		...
		if (list.size() == 0) {
			List<Object> rowList = new ArrayList<Object>(1);
