...
import org.vivi.framework.ureport.simple.ureport.utils.ElCompute;
...
public class Context {
	...
	public Map<String, String> getMapping(DatasetExpression expr) {
		if (expr.getMappingType().equals(MappingType.simple)) {
			...
			if (StringUtils.isNotBlank(expr.getMappingDataset()) && StringUtils.isNotBlank(expr.getMappingKeyProperty())
				...
				for (Object obj : list) {
					Object key = ToolUtils.getProperty(obj, expr.getMappingKeyProperty());
					Object value = ToolUtils.getProperty(obj, expr.getMappingValueProperty());
	...
	public Object evalExpr(String expression) {
		return ElCompute.doCompute(expression);
	}
