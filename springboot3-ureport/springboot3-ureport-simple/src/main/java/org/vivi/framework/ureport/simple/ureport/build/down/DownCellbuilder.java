 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.simple.ureport.build.down;

import java.util.List;
import java.util.Map;
import java.util.Set;

import org.vivi.framework.ureport.simple.ureport.build.BuildUtils;
...
public class DownCellbuilder {
	...
	private final static LeftParentCellCreator leftParentCellCreator = new LeftParentCellCreator();
