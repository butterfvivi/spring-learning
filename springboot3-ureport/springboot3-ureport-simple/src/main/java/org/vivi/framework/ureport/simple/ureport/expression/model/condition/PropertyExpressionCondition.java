 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.simple.ureport.expression.model.condition;
...
public class PropertyExpressionCondition extends BaseCondition {
	...
	Object computeLeft(Cell cell, Cell currentCell, Object obj, Context context) {
		if (StringUtils.isNotBlank(leftProperty)) {
			return ToolUtils.getProperty(obj, leftProperty);
		}
		return null;
	}
	...
	public void fetchCellName(List<String> list) {
		rightExpression.fetchCellName(list);
	}
}
