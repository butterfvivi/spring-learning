 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.simple.ureport.expression.model.expr.dataset;
...
import org.vivi.framework.ureport.simple.ureport.build.DatasetUtils;
...
public class DatasetExpression extends BaseExpression {
	...
	public void fetchCellName(List<String> list) {
		if(conditions != null && conditions.size() > 0) {
			ToolUtils.fetchCellName(conditions, list);
		}
	}
}
