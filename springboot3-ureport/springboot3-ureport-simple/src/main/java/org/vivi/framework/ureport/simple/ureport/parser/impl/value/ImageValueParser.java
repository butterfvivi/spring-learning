 ...
 * @since 2017年3月6日
 */
public class ImageValueParser implements Parser<ImageValue> {

	public final static Parser<ImageValue> instance = new ImageValueParser();
	
	@Override
	public ImageValue parse(Element element) {
	...
	public boolean support(String name) {
		return name.equals("image-value");
	}
}
