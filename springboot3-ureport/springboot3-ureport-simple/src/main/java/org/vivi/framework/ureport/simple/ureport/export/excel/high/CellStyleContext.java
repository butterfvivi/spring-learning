...
public class CellStyleContext {
	...
	private BorderStyle getBorderStyle(Border border) {
		if (border.getStyle().equals(org.vivi.framework.ureport.simple.ureport.definition.BorderStyle.solid)) {
			return BorderStyle.THIN;
		} else if (border.getStyle().equals(org.vivi.framework.ureport.simple.ureport.definition.BorderStyle.dashed)) {
			return BorderStyle.DASHED;
		} else if (border.getStyle().equals(org.vivi.framework.ureport.simple.ureport.definition.BorderStyle.doublesolid)) {
