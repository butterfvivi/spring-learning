...
public abstract class InputComponent implements Component {
    ...
    public String toHtml(RenderContext context) {
        ...
        sb.append("<div class='form-group' style='margin:0px 0px 10px 0px;display: flex;margin-right: -15px;margin-left: -15px;align-items: center;'>");
        if (this.labelPosition.equals(LabelPosition.top)) {
            sb.append("<span style='font-size:14px;'>" + this.label + "</span>");
            sb.append(inputHtml(context));
        } else {
            sb.append("<span class='col-md-3' style='text-align:right;padding-right:1px;font-size:14px'>" + this.label + "</span>");
