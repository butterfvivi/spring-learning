...
import org.vivi.framework.ureport.demo.core.definition.value.ExpressionValue;
...
import org.vivi.framework.ureport.demo.core.expression.function.page.PageFunction;
        ...
        if (expr instanceof IfExpression) {
            ...
            try {
                ...
                if (!CollectionUtils.isEmpty(expressionList)) {
                    // 如果是if else表达式
                    if (expressionList.get(0) instanceof IfExpression) {
                        IfExpression ifExpr = (IfExpression) expressionList.get(0);
                        return hasPageFunction(ifExpr.getExpression());
                    }
