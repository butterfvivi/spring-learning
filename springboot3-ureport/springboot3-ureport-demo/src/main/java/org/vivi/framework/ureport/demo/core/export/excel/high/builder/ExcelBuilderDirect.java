 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.demo.core.export.excel.high.builder;
...
import org.vivi.framework.ureport.demo.core.export.excel.high.CellStyleContext;
        ...
        try {
            ...
            for (Row r : rows) {
                ...
                for (int i = 0; i < columnSize; i++) {
                    ...
                    org.vivi.framework.ureport.demo.core.model.Cell cellInfo = null;
                    if (colCell != null) {
