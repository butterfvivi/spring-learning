 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.demo.core.export.html;
        ...
        for (int i = 0; i < rowSize; i++) {
            ...
            for (int j = 0; j < colSize; j++) {
                ...
                if (obj instanceof Image) {
                    ...
                    imgStyle.append("style=").append("\"").append("width: ").append(img.getWidth()).append("px;");
                    imgStyle.append(" height: ").append(img.getHeight()).append("px;\"");
