 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.demo.core.export.excel.low;
...
import org.vivi.framework.ureport.demo.core.definition.Orientation;
import org.vivi.framework.ureport.demo.core.definition.Paper;
import org.vivi.framework.ureport.demo.core.definition.PaperType;
...
import org.vivi.framework.ureport.demo.core.utils.ImageUtils;
...
public class Excel97Producer {
    ...
    private void doProduce(Report report, OutputStream outputStream, boolean withPaging, boolean withSheet) {
        ...
        try {
            ...
            Map<Row, Map<Column, org.vivi.framework.ureport.demo.core.model.Cell>> cellMap = report.getRowColCellMap();
            ...
            if (withPaging) {
                ...
                for (Page page : pages) {
                    ...
                    for (Row r : rows) {
                        ...
                        Map<Column, org.vivi.framework.ureport.demo.core.model.Cell> colCell = cellMap.get(r);
                        for (int i = 0; i < columnSize; i++) {
                            ...
                            org.vivi.framework.ureport.demo.core.model.Cell cellInfo = colCell.get(col);
                            if (cellInfo == null) {
                                continue;
                            }
