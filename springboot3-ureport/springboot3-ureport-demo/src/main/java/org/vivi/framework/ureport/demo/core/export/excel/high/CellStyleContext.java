 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.demo.core.export.excel.high;

import org.apache.poi.xssf.usermodel.*;
import org.vivi.framework.ureport.demo.core.definition.Alignment;
import org.vivi.framework.ureport.demo.core.definition.Border;
...
public class CellStyleContext {
    ...
    private BorderStyle getBorderStyle(Border border) {
        if (border.getStyle().equals(org.vivi.framework.ureport.demo.core.definition.BorderStyle.solid)) {
            return BorderStyle.THIN;
        } else if (border.getStyle().equals(org.vivi.framework.ureport.demo.core.definition.BorderStyle.dashed)) {
            return BorderStyle.DASHED;
        } else if (border.getStyle().equals(org.vivi.framework.ureport.demo.core.definition.BorderStyle.doublesolid)) {
