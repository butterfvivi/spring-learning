...
public class TextInputComponent extends InputComponent {
    ...
    String inputHtml(RenderContext context) {
        ...
        return "<input type='text' value=\"" + pvalue + "\" style=\"padding:3px;height:28px\" id='" + context.buildComponentId(this) + "' name='" + getBindParameter() + "' class='form-control' autocomplete='off'>";
    }
    ...
    public String initJs(RenderContext context) {
        ...
        sb.append("}");
        sb.append(");");
        // sb.append("$('#"+id+"').keyup(function(event){ if(event.keyCode == 13){ doSearch(); } });");
        return sb.toString();
    }
}
