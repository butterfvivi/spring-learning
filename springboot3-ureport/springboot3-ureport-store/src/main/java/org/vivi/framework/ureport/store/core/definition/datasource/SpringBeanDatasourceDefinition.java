 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.store.core.definition.datasource;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import org.vivi.framework.ureport.store.core.build.Dataset;
import org.vivi.framework.ureport.store.core.definition.dataset.BeanDatasetDefinition;
import org.vivi.framework.ureport.store.core.definition.dataset.DatasetDefinition;
