 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.store.core.export.excel.low;

import java.math.BigInteger;
import java.util.HashMap;
import java.util.Map;

import org.vivi.framework.ureport.store.core.definition.Alignment;
import org.vivi.framework.ureport.store.core.definition.Border;
import org.vivi.framework.ureport.store.core.definition.CellStyle;
...
public class CellStyleContext {
	...
	private BorderStyle getBorderStyle(Border border){
		if(border.getStyle().equals(org.vivi.framework.ureport.store.core.definition.BorderStyle.solid)){
			return BorderStyle.THIN;
		}else if(border.getStyle().equals(org.vivi.framework.ureport.store.core.definition.BorderStyle.dashed)){
			return BorderStyle.DASHED;
		}else if(border.getStyle().equals(org.vivi.framework.ureport.store.core.definition.BorderStyle.doublesolid)){
