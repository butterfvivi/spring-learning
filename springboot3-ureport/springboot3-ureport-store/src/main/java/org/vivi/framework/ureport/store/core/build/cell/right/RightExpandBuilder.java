 ...
 * the License.
 ******************************************************************************/
package org.vivi.framework.ureport.store.core.build.cell.right;

import org.vivi.framework.ureport.store.core.Range;
import org.vivi.framework.ureport.store.core.build.BindData;
import org.vivi.framework.ureport.store.core.build.Context;
import org.vivi.framework.ureport.store.core.build.cell.DuplicateType;
import org.vivi.framework.ureport.store.core.build.cell.ExpandBuilder;
import org.vivi.framework.ureport.store.core.definition.BlankCellInfo;
