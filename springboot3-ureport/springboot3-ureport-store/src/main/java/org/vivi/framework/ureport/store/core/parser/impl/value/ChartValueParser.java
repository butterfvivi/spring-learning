...
import org.vivi.framework.ureport.store.core.chart.axes.BaseAxes;
import org.vivi.framework.ureport.store.core.chart.axes.ScaleLabel;
import org.vivi.framework.ureport.store.core.chart.axes.impl.XAxes;
import org.vivi.framework.ureport.store.core.chart.axes.impl.YAxes;
import org.vivi.framework.ureport.store.core.chart.dataset.CollectType;
import org.vivi.framework.ureport.store.core.chart.dataset.Dataset;
import org.vivi.framework.ureport.store.core.chart.dataset.impl.BubbleDataset;
import org.vivi.framework.ureport.store.core.chart.dataset.impl.ScatterDataset;
import org.vivi.framework.ureport.store.core.chart.dataset.impl.category.*;
import org.vivi.framework.ureport.store.core.chart.option.Easing;
import org.vivi.framework.ureport.store.core.chart.option.Option;
import org.vivi.framework.ureport.store.core.chart.option.Position;
import org.vivi.framework.ureport.store.core.chart.option.impl.AnimationsOption;
import org.vivi.framework.ureport.store.core.chart.option.impl.LegendOption;
import org.vivi.framework.ureport.store.core.chart.option.impl.TitleOption;
import org.vivi.framework.ureport.store.core.chart.plugins.DataLabelsPlugin;
