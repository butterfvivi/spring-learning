<template>
  <div>
    ...
    size="mini"
    style="width: 100%">
      <el-table-column align="center" prop="name" label="参数名称" :show-overflow-tooltip="true" />
      <el-table-column align="center" prop="type" label="数据类型" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ paramTypeOptions.find(ele => ele.value === scope.row.type).label }}
        </template>
      </el-table-column>
      <el-table-column align="center" prop="defaultValue" label="默认值" :show-overflow-tooltip="true" />
    ...
    >
      <el-form :model="form" label-width="85px" ref="datasetParamRuleForm" :rules="rules" size="small">
        ...
        <div v-if="form.type==='Date'" style="color: #999999;font-size: 12px;margin-left: 85px;">时间格式需要加引号：'2024-01-01 00:00:00'</div>
