  ...
  <div style="padding: 8px;">
    <el-form :model="form" label-position="left" label-width="80px" size="mini">
      ...
      <el-form-item label="参数配置:">
        <el-button plain size="mini" @click="addUrlParam()">添加参数</el-button>
      </el-form-item>
    </el-form>
    <el-table size="mini" :header-cell-style="()=>'background: #f5f7fa'" border :data="form.linkParameters" height="300" style="width: 100%;margin-top: 10px;">
      <el-table-column prop="name" label="参数名称" header-align="center" />
      <el-table-column prop="value" label="参数表达式" header-align="center" />
      <el-table-column label="操作" width="80" align="center">
        <template slot-scope="scope">
          <el-link :underline="false" type="primary" @click="editUrlParam(scope.row)"><span style="font-size: 12px;">编辑</span></el-link>
          <el-link :underline="false" type="primary" @click="removeUrlParam(scope.row)"><span style="font-size: 12px;margin-left: 8px;">删除</span></el-link>
        </template>
      </el-table-column>
    </el-table>
    <el-dialog
