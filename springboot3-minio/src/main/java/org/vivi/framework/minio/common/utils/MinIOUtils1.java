...
public class MinIOUtils1 {
    ...
    public MinIOUtils1(String endpoint, String fileHost, String bucketName, String accessKey, String secretKey) {

        MinIOUtils1.endpoint = endpoint;
        MinIOUtils1.fileHost = fileHost;
        MinIOUtils1.bucketName = bucketName;
        MinIOUtils1.accessKey = accessKey;
        MinIOUtils1.secretKey = secretKey;
        createMinioClient();
    }
