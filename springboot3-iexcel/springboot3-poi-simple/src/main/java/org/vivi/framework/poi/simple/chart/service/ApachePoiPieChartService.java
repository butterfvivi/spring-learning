...
public class ApachePoiPieChartService {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // 将输出写入excel文件
            fileOut = new FileOutputStream("E:\\IdeaProjects\\springboot3-learning\\springboot3-iexcel\\springboot3-poi-simple\\src\\main\\resources\\file\\pie-chart-top-seven-countries.xlsx");
            wb.write(fileOut);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
