package org.vivi.framework.ireport.demo.report.cell;
 ...
 */
@Data
public class IHandleCell implements CellWriteHandler {
    ...
    public IHandleCell(Set<Integer> mergerColIndex, Set<Integer> excludeRowIndex, Boolean excludeTillRow, Integer headerWord, Integer mergerRowIndexLimit, Integer mergerColIndexLimit, Boolean isNeedLeftConditionMerge) {
    ...
    public void afterCellDispose(WriteSheetHolder writeSheetHolder, WriteTableHolder writeTableHolder,
        ...
        if (!isHead) {
            ...
            if (mergerColIndex.size() != 0 && mergerColIndex.contains(curColIndex)) {
                //当前单元格值
                Object curCellValue = InvokeCellUtils.getCellValue(cell);
                //同列的上一个单元格对象
                Cell upCell = InvokeCellUtils.getUpCell(cell);
                Object preCellVale = null;
                if (upCell != null) {
                    preCellVale = InvokeCellUtils.getCellValue(upCell);
                }
