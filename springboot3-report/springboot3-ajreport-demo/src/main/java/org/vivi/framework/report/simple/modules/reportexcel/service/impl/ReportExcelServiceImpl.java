package org.vivi.framework.report.simple.modules.reportexcel.service.impl;
...
import org.vivi.framework.report.simple.utils.AssertUtils;
import org.vivi.framework.report.simple.common.enums.ExportTypeEnum;
...
import org.vivi.framework.report.simple.common.enums.CellType;
...
@Service
public class ReportExcelServiceImpl extends ServiceImpl<ReportExcelMapper, ReportExcel> implements ReportExcelService {
    ...
    public ReportExcelDto preview(ReportExcelDto reportExcelDto) {
        ...
        AssertUtils.notNull(reportExcel, "500", "reportExcel");
        String setParam = reportExcelDto.getSetParam();

        BeanUtils.copyProperties(reportExcel, reportExcelDto);
    ...
    public void exportExcelCore(ReportExcelDto reportExcelDto) {
        ...
        try {
            ...
            try {
                ...
                throw new CommonException("file.operation.failed",e.getMessage());
            }
