...
import org.vivi.framework.report.service.mapper.reporttpldataset.ReportTplDatasetMapper;
...
import org.vivi.framework.report.service.web.dto.reporttpldataset.*;
...
//        }
    ...
    public Map<String, Object> getTplDatasetAndDatasource(Long tplId, String datasetName) throws Exception {
        ...
        {
            throw new BizException(StatusCode.FAILURE, "error.notexist");
        }
