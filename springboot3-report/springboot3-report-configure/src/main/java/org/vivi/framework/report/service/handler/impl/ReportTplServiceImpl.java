...
import org.vivi.framework.report.service.common.entity.EmailAttachementDto;
import org.vivi.framework.report.service.common.entity.PageEntity;
import org.vivi.framework.report.service.common.enums.*;
...
import org.vivi.framework.report.service.core.calculate.*;
import org.vivi.framework.report.service.core.process.LuckySheetBasicDynamicDataProcess;
import org.vivi.framework.report.service.handler.*;
import org.vivi.framework.report.service.mapper.luckysheetreportcell.LuckysheetReportCellMapper;
import org.vivi.framework.report.service.mapper.reporttpl.ReportTplMapper;
...
import org.vivi.framework.report.service.model.luckysheetonlinecell.LuckysheetOnlineCell;
...
import org.vivi.framework.report.service.model.onlinetplsheet.OnlineTplSheet;
...
import org.vivi.framework.report.service.model.reporttplsheetchart.ReportTplSheetChart;
import org.vivi.framework.report.service.web.dto.UserInfoDto;
import org.vivi.framework.report.service.web.dto.reporttpl.*;
import org.vivi.framework.report.service.core.process.LuckySheetListDataProcess;
import org.vivi.framework.report.service.model.reporttplsheet.ReportTplSheet;
import org.vivi.framework.report.service.model.luckysheetreportblockcell.LuckysheetReportBlockCell;
...
public class ReportTplServiceImpl extends ServiceImpl<ReportTplMapper, ReportTpl> implements IReportTplService {
   ...
   */
   ...
   public PageEntity tablePagingQuery(ReportTpl model) {
       ...
       List<ReportTplDto> list = reportTplMapper.getTableList(model);
   ...
   private Map<String, Object> getViewParams(List<Map<String, Object>> datasetParams, UserInfoDto userInfoDto) throws ParseException
   {
       ...
       if(!ListUtil.isEmpty(datasetParams))
       {
           for (int i = 0; i < datasetParams.size(); i++) {
               JSONArray jsonArray = JSONArray.parseArray(JSON.toJSONString(datasetParams.get(i).get("params")));
               Map<String, Object> params = ParamUtil.getViewParams(jsonArray,userInfoDto);
...
//					}
   ...
   private Map<String, Object> getDatasetDatas(ReportTpl reportTpl,MesGenerateReportDto mesGenerateReportDto,String datasetName,
       ...
       if(searchInfo != null)
       {
           ...
           params = ParamUtil.getViewParams(jsonArray,userInfoDto);
       }
       if(params == null) {
...
//		List<Map<String, Object>> border = this.getBorderType(borderConfig, luckySheetBindData.getCoordsx(), luckySheetBindData.getCoordsy());//获取该单元格的边框信息
       ...
       if(luckySheetBindData.getIsDict())
       {
           ...
           if(dicts != null)
           {
               value = dicts.get("reportDict:"+luckySheetBindData.getDatasourceId()+"_"+luckySheetBindData.getDictType()+"_"+bindDatas.get(j).get(0).get(property));
           }
       }else {
...
//            		}
           ...
           for (int t = 0; t < dataKeys.size(); t++) {
               if(subtotalCellDatas.containsKey(dataKeys.get(t)))
               {
                   ...
                   for (Entry<String, List<Map<String,Object>>> entry : subCalculateDatas.entrySet()) {
...
//           {
               ...
               List<ReportDatasourceDictData> dictDatas = this.iReportDatasourceDictDataService.list(dictDataQueryWrapper);
//               if(!ListUtil.isEmpty(dictDatas))
//               {
...
//           }
           if(!ListUtil.isEmpty(dictDatas))
           {
               ...
               for (int i = 0; i < dictDatas.size(); i++) {
                   result.put("reportDict:"+datasourceId+"_"+dictType+"_"+dictDatas.get(i).getDictValue(), dictDatas.get(i).getDictLabel());
               }
           }
       }
       return result;
